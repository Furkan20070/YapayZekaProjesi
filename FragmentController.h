...
public:
    ...
    //YAPILACAK
    //Şuan neigbour (komşular) sadece üst, alt, sağ ve sol olarak 4 tane atanıyor. Buna çarprazlarıda dahil etmem lazım.
    ...
    void createFragments(cv::Mat image)
    {
        ...
        for (int i = 0; i < rowAmount; i++)
        {
            for (int j = 0; j < colAmount; j++)
            {
                ...
                //Fragment oluştur.
                VisionFragment temp(id, center, divider, image, &suspects, &debugColors);
